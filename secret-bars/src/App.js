        ...
        <main>
          <Switch>
            <Route
             exact path="/" 
            //  component={Home}
            render={(props)=> <Home {...props}  listOfBars={this.state.listOfBars} setLocation={this.setLocation}/>}
            />

            <Route
              path="/:name/"
              render={routerProps => <ShowPage match={routerProps.match} listOfBars={this.state.listOfBars}/>}
            />
          </Switch>
        </main>
      </div>
